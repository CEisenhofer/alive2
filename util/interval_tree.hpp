...
// slightly modified version of: https://github.com/5cript/interval-tree
...
//############################################################################################################
    ...
    public:
        friend util::interval_tree <interval_type>;
        friend util::const_interval_tree_iterator <node <numerical_type, interval_type> >;
        friend util::interval_tree_iterator <node <numerical_type, interval_type> >;
